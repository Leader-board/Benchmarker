/* Similar to nomutex_forker but with an additional argument that tells how much each process is made to sleep. This is to test CPU/IO bound analysis, and also exhibits
how OSs react when processes go from sleep.
This is suitable both as a fork test and a purely thread test.
*/
#include <iostream>
#include <math.h>
#include <ctime>
...
int sleep_duration = 0; // how much should each process sleep?
void selection()
{
	int choose;
...
int main(int argc, char* argv[])
{
	...
	{
		cout << "invalid argument count, current number is " << argc << "\n";
		return -1;
	}
	...
	{
		// investigating thread fails
		cout << "thread allocation or join failed\n";
	}
